...
const Profile: NextPage = () => {
  return (
    <Layout title="나의 당근" hasTabBar>
      <section className="py-10 px-5 text-[#eee]">
        {/* profile */}
        ...
        {/* nav */}
        <nav className="mt-10 flex justify-around select-none">
          <button className="flex items-center gap-2 bg-[#333] rounded-md px-4 py-2 cursor-pointer">
            <svg
              className="w-6 h-6 text-signature-color"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            ...
            <span className="text-sm font-medium text-[#ccc]">판매내역</span>
          </button>
          <button className="flex items-center gap-2 bg-[#333] rounded-md px-4 py-2 cursor-pointer">
            <svg
              className="w-6 h-6 text-signature-color"
            ...
            <span className="text-sm font-medium text-[#ccc]">구매내역</span>
          </button>
          <button className="flex items-center gap-2 bg-[#333] rounded-md px-4 py-2 cursor-pointer">
            <svg
              className="w-6 h-6 text-signature-color"
            ...
            <span className="text-sm font-medium text-[#ccc]">관심목록</span>
          </button>
        </nav>
        <article className="mt-12">
          <aside className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[#444]" />
            <div>
